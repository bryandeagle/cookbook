...
Using the display panel select the PRESSURE COOK function. Use the +/- keys and program the Instant Pot for 30 minutes. When the time is up, let the pressure naturally release for 10 minutes, then quick-release the remaining pressure. Carefully remove the chicken from the pot to a cutting board, chop and return to the pot. Adjust seasonings.
